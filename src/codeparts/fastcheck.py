...
class fastcheck:
    ...
    def printinfo(self):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(f'Valorant Checker  |  Checked {self.checked}/{self.count}  |  {self.cpmtext} CPM  |  Hitrate {percent}  |  Est. time: {self.esttime}')
        os.system('cls')
        print(f'''
    {reset}
    {syst.center('VALORANT CHECKER')}
